...
}
{
    ...
    let urlhost1 = url.pathname;
    let fragmentoHtml = `<p class="contenedor" id="contenedor">
                            ${urlcap}
                         </p>` + `<p class="contenedor" id="contenedor">
                            ${urlhost}
                         </p>` + `<p class="contenedor" id="contenedor">
                            ${urlhost1}
                         </p>`;
    
    let contenedorHtml = document.getElementById("footer");
    contenedorHtml.insertAdjacentHTML("beforeend",fragmentoHtml);
